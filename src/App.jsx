    ...
    <body className="mw-full grid bg-[#141414] place-items-center">
      <div className="bg-[#1f1f1f] size-auto p-10 flex-col rounded-lg">
        <div className="text-center">
          ...
          <img src={profile} alt="foto-profile" className="rounded-full size-28"/>
          </div>
          <h1 className="text-white font-bold text-2xl pt-6"> Naufal Muhammad</h1>
          <h1 className="text-lime-400 font-medium text-lg">
            Depok, Indonesia
          </h1>
          <div className="text-normal italic text-white pt-7 py-5">
